export const languageChinese = {
    ...
    "vercelGatewaySettings": "Vercel AI Gateway 设置",
    ...
    "vercelSortAuto": "自动",
    "vercelSortCost": "最低成本",
    "vercelSortTTFT": "最快首个令牌",
    "vercelSortTPS": "最高吞吐量",
    "vercelServiceTier": "服务层级",
    "vercelTierDefault": "默认",
    "vercelTierPriority": "优先",
    "vercelTierFlex": "弹性",
    "vercelZeroDataRetention": "仅限零数据保留",
    "vercelDisallowPromptTraining": "禁止提示词训练",
    "vercelAutomaticCaching": "自动缓存",
