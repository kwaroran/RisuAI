export const languageChinese = {
    ...
    "seperateModelsForAxModels": "使用按用途划分的辅助模型",
    "doNotChangeSeperateModels": "预设更改时保留按用途划分的辅助模型",
    "memoryAuxModel": "记忆辅助模型",
    "translateAuxModel": "翻译辅助模型",
    "emotionAuxModel": "情绪辅助模型",
    "otherAuxModel": "其他辅助模型",
    "tools": "工具",
    "action": "动作",
    "hotkey": "快捷键",
    "hotkeyDesc": {
