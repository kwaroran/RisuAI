export const languageChinese = {
	...
	"errors": {
		"toomuchtoken": "错误：所需的最低token超过了最大上下文大小。",
	...
	"help": {
		...
		"creatorQuotes": "注意此在第一条消息的上方出现。用于向用户通报关于该角色的信息。它不会进入提示词。",
		"systemPrompt": "如果不为空，将替换设置中的主要提示。",
	...
	"character": "角色",
	"Chat": "聊天",
	"globalLoreInfo": "角色Lorebook适用于角色的所有聊天。",
	"group": "群组",
	"groupLoreInfo": "群组Lorebook适用于群组的所有聊天。",
	...
	"promptPreprocess": "使用提示预处理",
	"SwipeRegenerate": "使用滑动箭头重新生成",
	"instantRemove": "在删除消息时删除后续消息",
	"instantRemoveConfirm": "你是否想只删除一条消息？如果你选择否，那么它后面的消息也将被删除。",
	"textColor": "文本颜色",
	"classicRisu": "经典 Risu",
	"highcontrast": "高对比度",
	...
	"ShowLog": "显示请求日志",
	"waifuWidth2": "虚拟伴侣大小",
	"sayNothing": "当没有字符串输入时输入 'say nothing'",
	"regexScript": "正则表达式脚本",
	"type": "类型",
	"editInput": "修改输入",
	"editOutput": "修改输出",
	...
	"officialWiki": "官方Wiki",
	"officialWikiDesc": "RisuAI的官方Wiki，请随意查看。",
	...
	"innerFormat": "内部格式",
	"HypaMemory": "超记忆",
	"ToggleHypaMemory": "切换超记忆",
	"resetPromptTemplateConfirm": "你确定要重置提示模板吗？",
	"emotionMethod": "情绪方法",
	...
	"donatorPatreonDesc": "默认情况下，不会在列表中显示，以保护隐私。如果你想显示你的昵称，请前往 RisuAI 的 Patreon 页面并按下链接按钮。",
	"useNamePrefix": "使用名称前缀",
	"textAdventureNAI": "以文本冒险形式运行",
