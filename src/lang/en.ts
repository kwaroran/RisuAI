export const languageEnglish = {
    ...
    seperateModelsForAxModels: "Use Task-specific Auxiliary Models",
    doNotChangeSeperateModels: "Keep Task-specific Auxiliary Models on Preset Change",
    memoryAuxModel: "Memory Auxiliary Model",
    translateAuxModel: "Translation Auxiliary Model",
    emotionAuxModel: "Emotion Auxiliary Model",
    otherAuxModel: "Other Auxiliary Model",
    tools: "Tools",
    action: "Action",
    hotkey: "Hotkey",
    hotkeyDesc: {
