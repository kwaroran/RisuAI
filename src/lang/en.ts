export const languageEnglish = {
    ...
    customColorContrastText2DarkBackground: "Text 2 / Dark Background",
    customColorContrastExcellent: "Excellent",
    customColorContrastGood: "Good",
    customColorContrastLimited: "Limited",
    customColorContrastPoor: "Poor",
    customColorContrastLargeTextOnly: "Large text only",
    customColorContrastLowContrast: "Low contrast",
    customColorContrastUnavailable: "Unavailable",
