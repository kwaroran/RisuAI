export const languageKorean = {
    ...
    help:{
        ...
        regexScript: "정규식 스크립트는 IN에 매칭되는 텍스트를 OUT으로 변경하는 스크립트입니다.\n\n네가지 옵션이 있습니다."
                ...
                + "\n\n- @@emo (emotion name)\n\n    - 캐릭터가 감정 이미지 모드일시, 감정을 (emotion name)으로 정하고 감정을 더 이상 교체하지 않습니다.",
        ...
        excludeEmptyAssets: "활성화된 경우, AI에게 채팅을 보낼 때 캐릭터에 존재하지 않는 에셋을 제외합니다.\n장기적으로 AI가 캐릭터에 존재하지 않는 에셋을 언급할 가능성을 줄여줍니다.\n이 기능은 {{img::}} 와 같은 리스AI의 기본 에셋 형식에만 적용됩니다. "
    },
    setup: {
    ...
    excludeEmptyAssets: "존재하지 않는 에셋 제외하기",
}