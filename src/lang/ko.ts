export const languageKorean = {
    ...
    "help": {
        ...
        "sidePanelEmbedding": "채팅 화면 오른쪽에 표시되는 독립적인 마크다운/HTML 화면입니다. 내용이 변경되어도 최대한 기존 DOM 요소를 유지하면서 갱신합니다.\n\n대부분의 상태는 별도 설정 없이 유지됩니다. 그중 특정 요소의 상태를 계속 유지하고 싶다면, 화면이 갱신되어도 같은 요소로 식별될 수 있도록 중복되지 않는 `id`를 지정하세요.\n\n```html\n<div id=\"status-panel\">...</div>\n```",
