export const languageKorean = {
    ...
    "seperateModelsForAxModels": "용도별 보조 모델 사용",
    "doNotChangeSeperateModels": "프리셋 변경 시 용도별 보조 모델 유지",
    "memoryAuxModel": "메모리 보조 모델",
    "translateAuxModel": "번역 보조 모델",
    "emotionAuxModel": "감정 보조 모델",
    "otherAuxModel": "기타 보조 모델",
    "tools": "도구",
    "action": "동작",
    "hotkey": "단축키",
    "hotkeyDesc": {
