export const languageVietnamese = {
    ...
    "vercelGatewaySettings": "Cài đặt Vercel AI Gateway",
    "vercelAPIFormat": "Định dạng API",
    ...
    "vercelSortTTFT": "Token đầu tiên nhanh nhất",
    "vercelSortTPS": "Thông lượng cao nhất",
    "vercelServiceTier": "Cấp dịch vụ",
    "vercelTierDefault": "Mặc định",
    "vercelTierPriority": "Ưu tiên",
    "vercelTierFlex": "Linh hoạt",
    "vercelZeroDataRetention": "Chỉ lưu giữ dữ liệu bằng không",
    "vercelDisallowPromptTraining": "Không cho phép huấn luyện bằng lời nhắc",
    "vercelAutomaticCaching": "Bộ nhớ đệm tự động",
