export const languageChineseTraditional = {
    ...
    "seperateModelsForAxModels": "使用依用途區分的輔助模型",
    "doNotChangeSeperateModels": "套用預設時保留依用途區分的輔助模型設定",
    "memoryAuxModel": "記憶輔助模型",
    "translateAuxModel": "翻譯輔助模型",
    "emotionAuxModel": "情緒輔助模型",
    "otherAuxModel": "其他輔助模型",
    "tools": "工具",
    "action": "動作",
    "hotkey": "快捷鍵",
    "hotkeyDesc": {
