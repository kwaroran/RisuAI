export const languageSpanish = {
    ...
    "blockRealmCreator": "Bloquear creador",
    "blockRealmCreatorConfirm": "¿Bloquear todo el contenido de {{creator}} en RisuRealm?",
    "realmCreatorBlocked": "Este contenido pertenece a un creador de RisuRealm bloqueado y no está disponible.",
    "realmCreatorBlockedSuccess": "Creador bloqueado.",
    "manageBlockedRealmCreators": "Gestionar creadores bloqueados",
    "blockedRealmCreators": "Creadores de RisuRealm bloqueados",
    "noBlockedRealmCreators": "No hay creadores de RisuRealm bloqueados.",
    "unblockRealmCreator": "Desbloquear",
