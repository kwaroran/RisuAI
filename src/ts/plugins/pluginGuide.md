...
Welcome to the RisuAI Plugin Development Guide! This guide will help you create powerful, secure plugins for RisuAI using the modern **API v3.0**.
...
API v3.0 is the **recommended version for all new plugins**. It provides:

- **Enhanced Security**: Runs in an isolated iframe sandbox
- **Better Performance**: Optimized data exchange using structured cloning
- **Modern Architecture**: Async/await patterns throughout
- **Isolated Context**: Each plugin has its own environment
- **Custom UI Support**: Use your own iframe for rich interfaces

> **Note:** While API v2.1 is still supported, it may show security warnings in future versions. Always use v3.0 for new plugins.
...
- **API v3 Source**: [apiV3/v3.ts](./apiV3/v3.ts)
- **Plugin System**: [plugins.ts](./plugins.ts)
...
1. Check this guide and the [Migration Guide](./migrationGuide.md)
2. Review the [example plugins](#examples) above
